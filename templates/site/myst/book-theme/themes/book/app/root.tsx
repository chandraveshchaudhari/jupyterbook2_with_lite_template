      ...
      <Document
        ...
        head={
          <>
            ...
            <link rel="stylesheet" href={`${BASE_URL || ''}/_static/codemirror/codemirror.css`} />
            <link rel="stylesheet" href={`${BASE_URL || ''}/_static/pyodide.css`} />
            <script src={`${BASE_URL || ''}/_static/pyodide/pyodide.js`} defer />
            <script src={`${BASE_URL || ''}/_static/codemirror/codemirror.js`} defer />
            <script src={`${BASE_URL || ''}/_static/codemirror/python.js`} defer />
            <script src={`${BASE_URL || ''}/_static/pyodide-runner.js`} defer />
            <script src={`${BASE_URL || ''}/_static/pyodide-transform.js`} defer />
          </>
        }
      >
        <SkipTo
